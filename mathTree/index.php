...
//    }
    ...
    public function builder ($str): void
    {
...
//            $arLec = array();
        ...
        function objBuilder($point): Constant|Fission|Plus|Variable|Multiply|Minus|Exponent
        {
...
class Multiply extends Term {
    public function calc(): float|int
    {
        return $this->childrenLeft->calc()*$this->childrenRight->calc();
    }
}
...
class Exponent extends Term {
    public function calc(): float|object|int
    {
